  ...
  const features = [
    {
      ...
      description:
        "Unlock your potential with our internship program, learn all the important and trending skills in one place, ensuring you gain practical expertise for a successful professional future.",
      icon: Target,
    ...
    },
    {
      ...
      description:
        "Experience a friendly, supportive environment in our internship program, where our team offers daily guidance, constructive feedback, and encouragement to grow professionally.",
      icon: Brain,
    ...
    },
    {
      ...
      description:
        "Our short-term internship program gives you real client project experience. Apply your skills instantly & build a strong portfolio that helps you get hired faster.",
      icon: Award,
    ...
    },
    {
      ...
      description:
        "Gain practical skills through an internship for students, learning from professionals with real-world experience.",
      icon: UserCheck,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Why Choose{" "}
            <span className="text-gradient">Fillip Skill Academy</span>?
          </h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Choosing the right internship program is your gateway to success.
            Our short term internship program accelerates your learning, equips
            you with hands-on skills, and sets you on the path to a thriving
            professional future.
          </p>
        </div>
...
const HomePage = () => {
  return (
    <>
      <Helmet>
        <title>Dedicated Training & Internship Program for Skill Growth</title>
        <meta
          name="description"
  ...
  return (
    <div className="min-h-screen">
      ...
      <Routes>
        ...
        <Route
          path="/internship-in-web-development"
          element={<FillipInternshipPage />}
        />
        <Route
