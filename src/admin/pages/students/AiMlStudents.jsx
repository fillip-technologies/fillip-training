...
export default function AiMlStudents() {
    const [students, setStudents] = useState([
        {
            id: 1,
            name: "Manish",
            email: "manish.uiux@example.com",
            phone: "9876541230",
            batch: "Ai/Ml",
            mode: "Online",
            completed: false,
    ...
    return (
        <div>
            <h1 className="text-2xl font-semibold mb-4">Ai/Ml Course Students</h1>
